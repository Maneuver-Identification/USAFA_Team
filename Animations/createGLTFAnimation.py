...
# 
# This code uses Blender Python to generate animations for each of the tsv files in a given directory. This file is called in the shell script, generateAllAnimations.sh, which just requires the directory containing all the tsv files.
